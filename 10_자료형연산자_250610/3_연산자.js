...
// [지문8] 1차점수 와 2차점수 prompt함수로 각 입력받아서 총점이 150점이상이면 '합격' 아니면 '불합격' HTML의 <h3> 에 표시하시오.

// let numA = prompt("1차 점수")*1;
// let numB = prompt("2차 점수")*1;

// let sumResult = numA + numB ; 

// let reultPass = sumResult >= 150 ? "합격" : "불합격";

// document.write( `<h3> ${ sumResult }점, ${ reultPass }입니다. </h3>`);


// [지문9] 두 사람의 이름을 prompt함수로 각 입력받아서 만일 이름이 '유재석' 이면 뒤에 (방장) 이라고 이름 뒤에 붙이고 아니면 생략한다.  HTML의 <ol> 에 결과를 출력하시오. 

let nameA = prompt("1. 이름");
let nameB = prompt("2. 이름");

let resultName1 = nameA == "유재석" ? "(방장)" : "";
let resultName2 = nameB == "유재석" ? "(방장)" :"" ;
// let resultName2 = nameB == "유재석" ? "방장" : "";

document.write( `<ol><li> ${ nameA } ${ resultName1 } ${ nameB } ${ resultName2 } </li></ol>`);
